...
public sealed class ScanOptions
{
    ...
    public bool ScanARKSurvivalCheat { get; set; } = true;
    public bool ScanAltVDeepCheatForensic { get; set; } = true;
    public bool ScanFiveMServerLogCheat { get; set; } = true;
    public bool ScanLOLCheatForensic { get; set; } = true;
    public bool ScanSeaOfThievesCheat { get; set; } = true;
    public bool ScanDota2CheatArtifact { get; set; } = true;
    public bool ScanDeadByDaylightCheat { get; set; } = true;
    public bool ScanTeamFortress2Cheat { get; set; } = true;
    public bool ScanWarzoneCODCheat { get; set; } = true;
    public bool ScanWindowsEventLogCheatForensic { get; set; } = true;
    public bool ScanBattlefield2042Cheat { get; set; } = true;
    public bool ScanOverwatchCheatForensicDeep { get; set; } = true;
    public bool ScanPUBG2CheatDeep { get; set; } = true;
    public bool ScanRageMPDeepForensic { get; set; } = true;
    public bool ScanFiveMCrasherDetection { get; set; } = true;
    public bool ScanFiveMMoneyDropCheat { get; set; } = true;
    public bool ScanHaloInfiniteCheat { get; set; } = true;
    ...
    public bool ScanAltVResourceTamper { get; set; } = true;
    public bool ScanFiveMIdentitySpoof { get; set; } = true;
    public bool ScanFiveMNUIExploit { get; set; } = true;
    public bool ScanRageMPKickExploit { get; set; } = true;
    public bool ScanRageMPCEFExploit { get; set; } = true;
    public bool ScanEFTCheatDeep { get; set; } = true;
    public bool ScanValorantAimbotForensic { get; set; } = true;
    public bool ScanAltVPlayerDataSpoof { get; set; } = true;
    public bool ScanApexLegendsMacroForensic { get; set; } = true;
    public bool ScanAltVObjectSpawnAbuse { get; set; } = true;
    public bool ScanCS2WallhackForensic { get; set; } = true;
    public bool ScanFiveMPoliceAbuse { get; set; } = true;
    public bool ScanRustCheatForensic { get; set; } = true;
    public bool ScanAltVVehicleHack { get; set; } = true;
    public bool ScanFiveMBankHackForensic { get; set; } = true;
    ...
    public bool ScanFiveMRageMPAltVCleaner { get; set; } = true;
    public bool ScanFiveMRageMPAltVBypass { get; set; } = true;
    public bool ScanAntiForensicScannerEvasion { get; set; } = true;
    public bool ScanCleanerResidueForensic { get; set; } = true;
    ...
    public bool ScanFiveMRageMPAltVDeep { get; set; } = true;
    public bool ScanAntiScannerEvasionDeep { get; set; } = true;
    public bool ScanNetworkCheatForensic { get; set; } = true;
    ...
    public bool ScanKernelBypassRootkit { get; set; } = true;
    public bool ScanCheatLoaderUnpacker { get; set; } = true;
    public bool ScanVirtualMachineBanEvasion { get; set; } = true;
    public bool ScanFiveMServerSideCheat { get; set; } = true;
    public bool ScanRageMPServerExploit { get; set; } = true;
    public bool ScanAltVServerExploit { get; set; } = true;
    ...
    public bool ScanRageMPModMenuDeep { get; set; } = true;
    public bool ScanFiveMBanEvasionDeep { get; set; } = true;
    public bool ScanAltVModMenuDeep { get; set; } = true;
    public bool ScanRageMPBanEvasionDeep { get; set; } = true;
    public bool ScanFiveMScriptExecutorDeep { get; set; } = true;
    public bool ScanMenyooStuffDeep { get; set; } = true;
    public bool ScanFiveMNetEventExploit { get; set; } = true;
    public bool ScanGameRecordingCheatEvidence { get; set; } = true;
    public bool ScanAltVBanEvasionDeep { get; set; } = true;
    ...
    public bool ScanHardwareAimbotDevice { get; set; } = true;
    public bool ScanFiveMResourceExploitDeep { get; set; } = true;
...
public static class ScanProfiles
{
    public static ScanOptions Quick() => new ScanOptions
    {
        ...
        ScanARKSurvivalCheat = true,
        ScanAltVDeepCheatForensic = true,
        ScanFiveMServerLogCheat = true,
        ScanLOLCheatForensic = true,
        ScanSeaOfThievesCheat = true,
        ScanDota2CheatArtifact = true,
        ScanDeadByDaylightCheat = true,
        ScanTeamFortress2Cheat = true,
        ScanWarzoneCODCheat = true,
        ScanWindowsEventLogCheatForensic = true,
        ScanBattlefield2042Cheat = true,
        ScanOverwatchCheatForensicDeep = true,
        ScanPUBG2CheatDeep = true,
        ScanRageMPDeepForensic = true,
        ScanFiveMCrasherDetection = true,
        ScanFiveMMoneyDropCheat = true,
        ScanHaloInfiniteCheat = true,
        ...
        ScanAltVResourceTamper = true,
        ScanFiveMIdentitySpoof = true,
        ScanFiveMNUIExploit = true,
        ScanRageMPKickExploit = true,
        ScanRageMPCEFExploit = true,
        ScanEFTCheatDeep = true,
        ScanValorantAimbotForensic = true,
        ScanAltVPlayerDataSpoof = true,
        ScanApexLegendsMacroForensic = true,
        ScanAltVObjectSpawnAbuse = true,
        ScanCS2WallhackForensic = true,
        ScanFiveMPoliceAbuse = true,
        ScanRustCheatForensic = true,
        ScanAltVVehicleHack = true,
        ScanFiveMBankHackForensic = true,
        ...
        ScanFiveMRageMPAltVCleaner = true,
        ScanFiveMRageMPAltVBypass = true,
        ScanAntiForensicScannerEvasion = true,
        ScanCleanerResidueForensic = true,
        ...
        ScanFiveMRageMPAltVDeep = true,
        ScanAntiScannerEvasionDeep = true,
        ScanNetworkCheatForensic = true,
        ...
        ScanKernelBypassRootkit = true,
        ScanCheatLoaderUnpacker = true,
        ScanVirtualMachineBanEvasion = true,
        ScanFiveMServerSideCheat = true,
        ...
        ScanRageMPModMenuDeep = true,
        ScanFiveMBanEvasionDeep = true,
        ScanAltVModMenuDeep = true,
        ScanRageMPBanEvasionDeep = true,
        ScanFiveMScriptExecutorDeep = true,
        ScanMenyooStuffDeep = true,
        ScanFiveMNetEventExploit = true,
        ScanGameRecordingCheatEvidence = true,
        ScanAltVBanEvasionDeep = true,
        ScanKernelCheatDriverDeep = true,
        ScanFiveMTxAdminAbuseDeep = true,
        ScanAIAimbotDeep = true,
        ScanRobloxExecutorDeep = true,
        ScanHardwareAimbotDevice = true,
        ScanFiveMResourceExploitDeep = true,
        DeepDriveScan = false,
