  ...
  return (
    <div>
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatTile icon={Plus} label="Custom" value={state.customCheats.filter((c) => !c.builtin).length} accent="text-blue-500" />
      </div>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button onClick={add} className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500">
              Add
            </button>
          </>
        }
