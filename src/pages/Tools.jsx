    ...
    <Card className="p-6 md:p-8">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <button
          onClick={run}
          disabled={busy}
          className="flex shrink-0 items-center justify-center gap-2 rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-sky-500 disabled:opacity-60"
        >
  ...
  return (
    <Card className="p-6 md:p-8">
      ...
      <div className="mt-4 flex justify-end gap-3">
        ...
        <button onClick={run} className="rounded-lg bg-sky-600 px-5 py-2 text-sm font-semibold text-white hover:bg-sky-500">
          Analyze
        </button>
      </div>
  ...
  return (
    <Card className="p-6 md:p-8">
      ...
      <button
        ...
        className="bd flex w-full flex-col items-center justify-center rounded-xl border-2 border-dashed py-14 hover:border-sky-500"
      >
