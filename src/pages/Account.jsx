...
const inputCls =
  'bd tile txt w-full rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-sky-500/40'
        ...
        <Card className="p-6 md:p-8">
          {tab === 'general' && (
            <div className="space-y-5">
              ...
              <button onClick={() => toast({ type: 'success', title: 'Profile saved' })} className="rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-sky-500">
                Save changes
              </button>
            </div>
          )}
          ...
          {tab === 'security' && (
            <div className="space-y-2">
              <div className="bd flex flex-col gap-3 border-b py-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button onClick={() => setPwOpen(true)} className="bd txt flex items-center gap-2 rounded-lg border px-5 py-2.5 text-sm font-medium hover:border-sky-500">
          ...
          {tab === 'connections' && (
            <div className="space-y-5">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-sky-500"
              >
          ...
          {tab === 'billing' && (
            <div className="space-y-5">
              ...
              <div className="tile flex items-center justify-between rounded-xl border p-5">
                ...
                <button onClick={() => nav('/pricing')} className="rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-sky-500">
                  View plans
                </button>
              </div>
            </div>
              ...
              <div className="flex gap-6">
                {[
                  ...
                  <button key={f.v} onClick={() => setFmt(f.v)} className="flex items-center gap-2 text-sm">
                    <span className={`flex h-4 w-4 items-center justify-center rounded-full border ${fmt === f.v ? 'border-sky-500' : 'bd'}`}>
                      {fmt === f.v && <span className="h-2 w-2 rounded-full bg-sky-500" />}
                    </span>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <button
                      ...
                      className={`tile flex w-full items-center gap-4 rounded-xl border p-4 text-left ${sel[o.k] ? 'border-sky-500/50' : ''}`}
                    >
                      <span className={`flex h-5 w-5 items-center justify-center rounded ${sel[o.k] ? 'bg-sky-600 text-white' : 'bd tile'}`}>
