  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <button onClick={() => setOpen(true)} className="flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-500">
                ...
                <div key={t.id} className="tile rounded-lg border p-4">
                  ...
                  {t.status === 'Open' && (
                    <button
                      ...
                      className="mt-3 text-xs font-medium text-blue-500 hover:text-blue-400"
                    >
                      Mark as resolved
                    </button>
                  )}
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button onClick={submit} className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500">Submit</button>
          </>
        }
      >
